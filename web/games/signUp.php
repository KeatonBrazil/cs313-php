...
$no_pass_match=$_GET['no_pass_match'];
$no_email=$_GET['no_email'];
$no_email_match=$_GET['no_email_match'];
...
<body>
    ...
    <div class="white center" id="return">
        <form action="addUser.php" method="post">
            ...
            <?php if ($no_pass_match) {echo "<p><span class='red'>Password and Confirm Password do not match</span></p>";} ?>
            ...
            <?php if ($no_email_match) {echo "<p><span class='red'>Email and Confirm Email do not match</span></p>";} ?>
