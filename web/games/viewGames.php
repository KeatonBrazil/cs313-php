...
$query = 'SELECT bg.game_id, title, time_length_min, complexity, num_players FROM game.boardGame bg LEFT JOIN game.game g ON bg.game_id=g.game_id ORDER BY title';
